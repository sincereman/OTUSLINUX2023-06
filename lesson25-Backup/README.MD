...
sincere@sincere-ubuntuotus:~/vagrantdocs/lesson25-Backup/vm/ansible/rsa-key$ ssh-keygen -t ed25519 -f ./backup_borg
Generating public/private ed25519 key pair.
Enter passphrase (empty for no passphrase): 
Enter same passphrase again: 
Your identification has been saved in ./backup_borg
Your public key has been saved in ./backup_borg.pub
...
В итоге неполучалось и решил остановиться на предопределенной паре.
...
зайти на сервер dataserver и ввести пуками команду для первоначальной инициализации и ввода паролей. 
Команду на неинтерактивную арольную фразу не нашел (
