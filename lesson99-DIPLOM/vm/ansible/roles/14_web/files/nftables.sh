...
# allow input inet to 80,443 www

nft 'add rule ip filter INPUT iifname eth1 ip saddr { 192.168.225.10, 192.168.225.11} tcp dport { 80, 443 } counter accept comment "http"'
