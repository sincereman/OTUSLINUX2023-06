...
# allow input inet to 514 rsyslog server

nft 'add rule ip filter INPUT iifname eth1 ip saddr { 10.99.1.0/24, 192.168.0.0/16} tcp dport 514 counter accept comment "rsyslog1 server"'
