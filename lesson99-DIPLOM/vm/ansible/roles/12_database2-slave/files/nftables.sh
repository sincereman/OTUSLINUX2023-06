...
# allow input inet to 3306 zabbix server

nft 'add rule ip filter INPUT iifname eth1 ip saddr { 192.168.225.10, 192.168.225.11} tcp dport 3306 counter accept comment "mysql"'
